...
```text
docs/00\_PRODUCT\_SPEC.md
docs/01\_ARCHITECTURE.md
docs/02\_DATA\_MODEL.md
docs/03\_PRIVACY\_RLS.md
docs/04\_ENTITLEMENTS.md
docs/05\_ROUTES\_AND\_FLOWS.md
...
```text
docs/engines/PLAN\_ENGINE.md
docs/engines/NUTRITION\_ENGINE.md
docs/engines/SOURCES\_EXTRACTION.md
docs/engines/WEATHER\_CONDITIONS.md
docs/engines/RACE\_INTELLIGENCE.md
```
...
Do not trust client-supplied `user\_id`.

\---

# 26\. service\_role rule

`service\_role` bypasses RLS technically.
...
Never treat service\_role as business authorization.
...
At minimum, follow `docs/ACCEPTANCE\_CRITERIA.md`.
...
conditions\_opened
outing\_created
org\_participants\_imported
org\_analysis\_opened
```
...
```text
BLOCKER:
WEATHER\_CONDITIONS.md does not define the production threshold for cold detection.
